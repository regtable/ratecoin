...
int64_t GetProofOfStakeRewardV2(int64_t nCoinAge, int64_t nFees, unsigned int nAge);
...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge, unsigned int& nAge) const;  // ppcoin: get transaction coin age
